...
use Skytells\Database\Eloquent\Relations\Concerns\SupportsDefaultModels;
...
class BelongsTo extends Relation
{
     ...
     * @param  \Skytells\Database\Eloquent\Model  $child
     ...
     *
     * @param  \Skytells\Database\Eloquent\Model|int|string  $model
