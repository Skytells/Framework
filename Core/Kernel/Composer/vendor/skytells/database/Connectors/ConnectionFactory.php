...
namespace Skytells\Database\Connectors;

use PDOException;
use Skytells\Support\Arr;
use InvalidArgumentException;
use Skytells\Database\Connection;
use Skytells\Database\MySqlConnection;
use Skytells\Database\SQLiteConnection;
use Skytells\Database\PostgresConnection;
use Skytells\Database\SqlServerConnection;
use Skytells\Contracts\Container\Container;
use Skytells\Contracts\Debug\ExceptionHandler;
...
class ConnectionFactory
{
     ...
     *
     * @param  array  $config
     * @return \Skytells\Database\Connectors\ConnectorInterface
     *
