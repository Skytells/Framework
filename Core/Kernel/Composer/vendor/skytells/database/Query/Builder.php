...
namespace Skytells\Database\Query;
...
use Skytells\Pagination\Paginator;
use Skytells\Support\Traits\Macroable;
use Skytells\Contracts\Support\Arrayable;
use Skytells\Database\ConnectionInterface;
use Skytells\Database\Concerns\BuildsQueries;
use Skytells\Database\Query\Grammars\Grammar;
use Skytells\Database\Query\Processors\Processor;
use Skytells\Database\Eloquent\Builder as EloquentBuilder;
...
class Builder
{
     ...
     *
     * @var \Skytells\Database\Query\Grammars\Grammar
     */
    public $grammar;
     ...
     *
     * @var \Skytells\Database\Query\Processors\Processor
     */
    public $processor;
     ...
     *
     * @param  \Skytells\Database\ConnectionInterface  $connection
     * @param  \Skytells\Database\Query\Grammars\Grammar  $grammar
     * @param  \Skytells\Database\Query\Processors\Processor  $processor
     * @return void
     */
     ...
     * @return \Skytells\Database\Query\Builder|static
     */
     ...
     *
     * @param  \Closure|\Skytells\Database\Query\Builder|string $query
     * @param  string  $as
     * @return \Skytells\Database\Query\Builder|static
     *
     ...
     *
     * @param  string   $column
     * @param  \Skytells\Database\Query\Builder|static  $query
     * @param  string   $boolean
     * @param  bool     $not
     * @return $this
     */
     ...
     *
     * @param  \Skytells\Database\Query\Builder|\Closure  $query
     * @param  bool  $all
     * @return \Skytells\Database\Query\Builder|static
     */
     ...
     * @param  int|null  $page
     * @return \Skytells\Contracts\Pagination\LengthAwarePaginator
     */
     ...
     * @param  string  $pageName
     * @param  int|null  $page
     * @return \Skytells\Contracts\Pagination\Paginator
     */
     ...
     *
     * @param  mixed  $value
     * @return \Skytells\Database\Query\Expression
     */
     ...
     *
     * @return \Skytells\Database\ConnectionInterface
     */
     ...
     *
     * @return \Skytells\Database\Query\Processors\Processor
     */
     ...
     *
     * @return \Skytells\Database\Query\Grammars\Grammar
     */
