...
use Skytells\Contracts\Broadcasting\ShouldBroadcast;
use Skytells\Contracts\Events\Dispatcher as DispatcherContract;
use Skytells\Contracts\Broadcasting\Factory as BroadcastFactory;
use Skytells\Contracts\Container\Container as ContainerContract;
...
class Dispatcher implements DispatcherContract
{
     ...
     *
     * @param  \Skytells\Contracts\Container\Container|null  $container
     * @return void
     */
     ...
     *
     * @param  \Skytells\Contracts\Broadcasting\ShouldBroadcast  $event
     * @return void
     */
    ...
    protected function callQueueMethodOnHandler($class, $method, $arguments)
    {
        ...
        $handler->queue($this->resolveQueue(), 'Skytells\Events\CallQueuedHandler@call', [
