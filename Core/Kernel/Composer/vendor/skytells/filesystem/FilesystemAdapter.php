...
namespace Skytells\Filesystem;

use RuntimeException;
use Skytells\Http\File;
use Skytells\Support\Str;
use InvalidArgumentException;
use Skytells\Http\UploadedFile;
...
use Skytells\Contracts\Filesystem\Cloud as CloudFilesystemContract;
use Skytells\Contracts\Filesystem\Filesystem as FilesystemContract;
use Skytells\Contracts\Filesystem\FileNotFoundException as ContractFileNotFoundException;
...
class FilesystemAdapter implements FilesystemContract, CloudFilesystemContract
{
     ...
     * @return string
     *
     * @throws \Skytells\Contracts\Filesystem\FileNotFoundException
     */
     ...
     *
     * @param  string  $path
     * @param  \Skytells\Http\File|\Skytells\Http\UploadedFile  $file
     * @param  array  $options
     * @return string|false
     */
