         ...
         <div class="mdl-tabs__panel is-active" id="tab1-panel">
            <div class="mdl-grid mdl-grid--no-spacing">
               <div class="mdl-cell mdl-cell--4-col">
                  ...
                  <span class="darkgrey">
                     Framework Version &nbsp; : &nbsp;
                     <O class="red"><?= $_REQUEST['fwver']; ?></O>
                     <? if ($Data->Settings->ALLOW_TERMINAL == TRUE) { ?> &nbsp;(
                     <a href="#" title="Open Terminal" class="openModal" id="openTerminal">Terminal</a> ) <? } ?>
                  </span>
                  <br>
                  <i class="fa fa-code"></i>
                  <span class="darkgrey">
                     Current PHP Version : &nbsp;
                     <O class="blue"><?= phpversion(); ?></O>
                  </span>
                  <br>
                  <i class="fa fa-clock-o"></i>
                  <span class="darkgrey">
                     System Benchmark &nbsp; &nbsp;: &nbsp;
                     <O class="grey"><?= $Data->benchmark; ?> ms</O>
                  </span>
                  <br>
               ...
               <div class="mdl-cell mdl-cell--4-col">
                  ...
                  <span class="darkgrey">
                     Total Cached &nbsp; &nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp;: &nbsp;
                     <O class="orange"><?= $Data->totalCached; ?></O>
                     &nbsp;( <a target="_parent" class="darkgreen" href="<?=$Data->homebase;?>?action=flushcache">Flush</a> )
                  </span>
                  <br>
                  <i class="fa fa-language"></i>
                  <span class="darkgrey">
                     Active Language &nbsp;&nbsp; &nbsp;: &nbsp;
                     <O class="blue"><?= $Data->language ?></O>
                     &nbsp;( <a class="darkgreen" target="_parent" href="<?=$Data->homebase;?>?lang=fr_FR">Change</a> )
                  </span>
                  <br>
               ...
               <div class="mdl-cell mdl-cell--4-col">
                  ...
                  <span class="darkgrey">
                     Loaded Helpers &nbsp;&nbsp;: &nbsp;
                     <O class="orange"><?= count((array)$Data->Runtime->Helpers); ?></O>
                     &nbsp;( <a  class="darkgreen" href="#" onclick="cview('Helpers')">Show</a> )
                  </span>
                  <br>
                  <i class="fa fa-modx"></i>
                  <span class="darkgrey">
                     Loaded Models &nbsp;&nbsp; : &nbsp;
                     <O class="orange"><?= count((array)$Data->Runtime->Models); ?></O>
                     &nbsp;( <a  class="darkgreen" href="#" onclick="cview('Models')">Show</a> )
                  </span>
                  <br>
                  <i class="fa fa-eercast"></i>
                  <span class="darkgrey">
                     Loaded Handlers : &nbsp;
                     <O class="orange"><?= count((array)$Data->Runtime->Handlers); ?></O>
                     &nbsp;( <a  class="darkgreen" href="#" onclick="cview('Handlers')">Show</a> )
                  </span>
                  <br>
                  <i class="fa fa-dropbox"></i>
                  <span class="darkgrey">
                     Loaded Libraries &nbsp;: &nbsp;
                     <O class="orange"><?= count((array)$Data->Runtime->Libraries); ?></O>
                     &nbsp;( <a  class="darkgreen" href="#" onclick="cview('Libraries')">Show</a> )
                  </span>
               </div>
            </div>
         </div>
